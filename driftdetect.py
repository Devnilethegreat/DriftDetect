# driftdetect.py
"""
Main module for DriftDetect application.
"""
...
class DriftDetectCore:
    """Core processing class for DriftDetect."""
...
class DriftDetect:
    """Main orchestrator for DriftDetect."""

    def __init__(self, verbose: bool = False):
        self.verbose = verbose
        self.threshold = float(os.getenv("THRESHOLD", "0.75"))
        self.core = DriftDetectCore(threshold=self.threshold, verbose=verbose)
    ...
    def run(self) -> bool:
        try:
            self.logger.info("Starting DriftDetect processing pipeline")
